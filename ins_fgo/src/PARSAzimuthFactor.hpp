...
class AzimuthFactor : public gtsam::NoiseModelFactor1<gtsam::Pose3>
{
  public:
    AzimuthFactor(gtsam::Key j, const gtsam::SharedNoiseModel &model, double azimuth, const gtsam::Point3 &l)
        : gtsam::NoiseModelFactor1<gtsam::Pose3>{model, j}, m_z{azimuth}, m_l{l}
    {
    }
