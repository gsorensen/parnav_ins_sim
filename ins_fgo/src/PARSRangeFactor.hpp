...
class RangeFactor : public gtsam::NoiseModelFactor1<gtsam::Pose3>
{
  public:
    RangeFactor(gtsam::Key j, const gtsam::SharedNoiseModel &model, double range, const gtsam::Point3 &l)
        : gtsam::NoiseModelFactor1<gtsam::Pose3>{model, j}, m_z{range}, m_l{l}
    {
    }
